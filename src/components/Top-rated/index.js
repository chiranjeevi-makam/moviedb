...
class TopRated extends Component {
  ...
  getDetails = async () => {
    const url = `https://api.themoviedb.org/3/movie/top_rated?api_key=${'256523ad59c77acbdc3fef4b0cf95016'}&language=en-US&page=1`
    const position = {
      method: 'GET',
      headers: {
    ...
    this.setState({posterData: dataFormat, typeName: 'Top Rated'})
  }
